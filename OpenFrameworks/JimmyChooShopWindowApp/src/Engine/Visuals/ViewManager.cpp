...
void ViewManager::setupBackgroundImage()
{
    m_backgroundImage.setResource("GradientBackground");
    m_backgroundImage.setWidth(ofGetWidth());
    m_backgroundImage.setHeight(ofGetHeight());
